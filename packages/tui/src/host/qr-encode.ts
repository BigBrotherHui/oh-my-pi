/**
 * Self-contained QR Code encoder (byte mode, versions 1-40, EC levels
 * L/M/Q/H) following ISO/IEC 18004. Pure data: the `qr` host element paints
 * the resulting {@link QrMatrix}. Used by `/collab qrcode` for browser-join codes.
 */
import type { QrMatrix } from "./elements/qr";
 ...
 * renderers need.
 */
export class QrCode implements QrMatrix {
