 ...
 */
const JEVIFY_GRADIENT = {
	probe: /jevify/,
	highlight: magicKeywordRegex("jevify", "g"),
	stops: 14,
	hue: (t: number) => (300 + t * 120) % 360,
};

export const highlightJevify: KeywordHighlighter = createGradientHighlighter(JEVIFY_GRADIENT);
export const decorateJevify: KeywordDecorator = createGradientDecorator(JEVIFY_GRADIENT);
